...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2015/11/27 17:05:17 by anespoul          #+#    #+#              #
#    Updated: 2015/12/26 18:22:12 by anespoul         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	  ...
	  ft_lstmap.c ft_size_list.c ft_reverse_list.c ft_swap_list.c
...
OBJ = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o \
	  ...
	  ft_lstmap.o ft_size_list.o ft_reverse_list.o ft_swap_list.o
...
$(OBJ):
	gcc -c $(SRC) -I $(INCLUDE) -Wall -Werror -Wextra
